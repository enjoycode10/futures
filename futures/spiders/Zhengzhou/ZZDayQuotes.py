...
class ZZDayQuotes(Spider):
    name = 'zhengzhou_day_quotes'

    def start_requests(self):
        base_url = 'http://www.czce.com.cn/cn/DFSStaticFiles/Future/{}/{}/FutureDataDaily.htm'
        base_url2 = 'http://www.czce.com.cn/portal/exchange/{}/datadaily/{}.htm'

        date_list = self.get_datelist(3)
    ...
    def parse(self, response):
        ...
        table_list = Selector(text=web_text).xpath('//*/table[@id="tab1"]/tr')
        for row in table_list:
            ...
            if cell_list[0].strip() in FITTER_KEY:
                ...
                if cell_list[0][0:2] in Zhengzhou_item.keys():
                    # logging.info(cell_list)
                    item = DayQuotesItem()

                    good_name = cell_list[0][:]
                    delivery_str = cell_list[0][2:]
