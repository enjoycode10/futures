...
from futures.spiders.Zhengzhou.ZZDayQuotes import ZZDayQuotes
...
def run():
    ...
    # process.crawl(ZZDayQuotes)  # 郑州日行情
...
if __name__ == '__main__':
    ...
    logging.basicConfig(format='%(asctime)s %(filename)s %(funcName)s %(levelname)-8s %(message)s', level=logging.INFO)
